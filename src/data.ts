...
export const womanData = <Array<IWomanData>>[
    ...
    },
    {
        ...
        "paragraphs": [
            {
                "name": "Biografia",
                "paragraph": "Esperança Garcia, considerada a 1 mulher advogada do brasil. escravizada que se destacou pela luta contra o racismo e por direitos humanos. Garcia Esperança foi uma líder importante no Quilombo do Ribeirão, ela organizou a comunidade quilombola e defendeu seus direitos contra as forças coloniais. Além de sua atuação militar, Garcia também preservou as tradições africanas, transmitindo conhecimentos sobre medicina herbal e práticas culturais. Seu legado simboliza a resistência feminina e a luta por liberdade, inspirando muitas mulheres até hoje.\nConsiderada a 1ª mulher advogada do Brasil. Conhecida por sua coragem e resistência na luta pela liberdade de seu povo. Esperança nasceu em uma fazenda de propriedade dos jesuítas, onde hoje fica o município de Nazaré do Piauí. Aos 9 anos de idade, quando a ordem foi expulsa do Piauí pelo Marquês de Pombal, ela foi levada como escrava para a casa do capitão Antônio Vieira de Couto. Aos 16 anos, teve seu primeiro filho.\n Em 6 de setembro de 1770, escreveu uma carta ao governador da Capitania do Piauí, Gonçalo Lourenço Botelho de Castro, denunciando os maus-tratos que sofria. Pedia ainda para retornar à Fazenda Algodões e para ter sua filha batizada. Fugiu pouco depois, reaparecendo numa relação de trabalhadores escravizados da Fazenda Algodões, datada de 1778, casada com o angolano Ignácio e com sete filhos.\nA carta de Esperança Garcia é considerada a primeira petição escrita por uma mulher na história do Brasil, o que a torna uma precursora da advocacia no país e no estado do Piauí. Também é um documento importante na origem da literatura afro-brasileira. \n Na data de envio, 6 de setembro, é comemorado o Dia Estadual da Consciência Negra no Piauí. Em 2017, o Memorial Zumbi  Palmares, espaço dedicado à cultura negra em Teresina, foi reformado e reinaugurado com o nome de Memorial Esperança Garcia. Garcia tendo sua história contada nos quadrinhos. De autoria do escritor e pesquisador piauiense João P. Luiz, em parceria com o quadrinista Bernardo Aurélio, a obra tem alcançado principalmente o público infantojuvenil, trazendo à tona a trajetória de resistência de Esperança Garcia e sua contribuição para a luta contra a escravidão e o machismo.\n Segundo João P. Luiz, os quadrinhos são uma mídia democrática, com grande potencial para atingir públicos diversos, incluindo aqueles que não teriam acesso a livros tradicionais. Seu legado simboliza a resistência feminina e a luta por liberdade, inspirando muitas mulheres até hoje. "
            }
        ]
    },
    {
